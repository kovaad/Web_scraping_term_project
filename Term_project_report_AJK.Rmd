...
ggplot(final_df2, aes(platforms_used)) +
  geom_histogram(colour="firebrick4", fill="lightblue", bins=6) +
  geom_vline(aes(xintercept=mean(platforms_used)),
             color="black", linetype="dashed", size=1) +
  geom_text(aes(mean(platforms_used), 15, label=paste0("Mean: ",round(mean(platforms_used), 2))), hjust = 1.2, vjust = -12) +
...
ggplot(final_df2, aes(peak_reached)) +
  geom_histogram(colour="firebrick4", fill="lightblue", binwidth=2) +
  geom_vline(aes(xintercept=mean(peak_reached)),
             color="black", linetype="dashed", size=1) +
  geom_text(aes(mean(peak_reached), 15, label=paste0("Mean: ",round(mean(peak_reached), 2))), hjust = 1.2, vjust = -12) +
